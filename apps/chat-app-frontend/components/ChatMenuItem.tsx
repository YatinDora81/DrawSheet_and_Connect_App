...
const ChatMenuItem = ({ setShowRoomInfoPage, setResponsivePage, responsivePage }: { setShowRoomInfoPage: (val: boolean) => void, setResponsivePage: (val: number) => void, responsivePage: number }) => {

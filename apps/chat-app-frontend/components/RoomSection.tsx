...
export function RoomSection (){
    ...
    return <div style={{paddingInline : "15px" , paddingBlock : "10px" }} className=" min-h-[90vh] max-h-[90vh]  w-[35%]  bg-zinc-800 flex flex-col items-start justify-start gap-4 overflow-y-auto custom-scrollbar">

        {
            ...
            <div className="flex flex-col items-center justify-center h-[87vh] text-center p-6 bg-zinc-900 rounded-lg shadow-lg">
                ...
                <button className="mt-4 px-5 py-2 bg-green-600 text-black font-semibold rounded-lg hover:bg-green-700 cursor-pointer transition-all">
                    Create New Room
                </button>

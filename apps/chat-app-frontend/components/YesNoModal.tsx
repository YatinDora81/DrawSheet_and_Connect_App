...
const YesNoModal = ({ showModal, setShowModal, heading = "Are You Sure???", subheading, setValue }: { showModal: number, setShowModal: (value: number) => void, heading: string, setValue: (value: number) => void , subheading : string | null }) => {

    ...
    return (
        <div style={{ paddingInline: "15px", paddingBlock: "10px" }} className=" min-h-[90vh] max-h-[90vh]  w-[65%]  bg-zinc-800 flex flex-col items-start justify-start gap-4 overflow-y-auto custom-scrollbar">
            ...
            <div className=' w-full h-full bg-zinc-900 rounded-xl'>
                ...
                {/* Chat Section NavBar */}
                {!flag && <div className='  border-b-2 border-zinc-600 flex items-center justify-between h-20 w-full ' style={{ paddingInline: "18px" }}>
                ...
                {/* Chat Section */}
                {!flag && <div className=' max-h-[67vh] custom-scrollbar scroll-smooth overflow-y-auto min-h-[67vh] w-full bg-ink-600 px-4 py-4 flex flex-col '>
                ...
                {/* Input Section */}
                {!flag && <div className=' h-16 bg-blue 700 w-full flex justify-evenly items-center'>
                    <input type='text' className=' bg-zinc-800 w-[90%] p-3 rounded-2xl' placeholder='Enter Message Here!!!!'></input>
                    <button className=' text-2xl border-green-800 rounded-xl bg-green-700  p-[11px]'><IoSend className=' text-white' /></button>
                </div>}

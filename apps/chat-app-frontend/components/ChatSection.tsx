...
const ChatSection = ({ setModal }: { setModal: (val: number) => void }) => {
    ...
    return (
            ...
            <div style={{ paddingInline: "15px", paddingBlock: "10px" }} className=" min-h-[90vh] max-h-[90vh]  w-full  bg-zinc-800 flex flex items-start justify-start gap-4 overflow-y-auto custom-scrollbar">

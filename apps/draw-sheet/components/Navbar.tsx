...
function Navbar() {
    return (
        <div className=" w-full border-b h-[4.5rem] top-0 sticky backdrop-blur-lg bg-zinc-950 z-[100] border-b-zinc-800">
            <div className=" h-full globalPadding text-white font-sans flex w-full md:w-[85rem]   " style={{ marginInline: "auto"  }}>
                ...
                <div className=" flex justify-between w-full items-center">
                    ...
                    <div className=" h-full flex gap-3 justify-center items-center">
                        ...
                        <Link href={"/signup"} className=" border hidden sm:flex justify-center items-center h-[50%] w-[6.5rem] font-semibold border-zinc-800 rounded-lg cursor-pointer bg-blue-500 hover:opacity-80 gap-2 transition-all duration-100 text-sm" style={{ paddingInline: "" }}>Sign up</Link>
